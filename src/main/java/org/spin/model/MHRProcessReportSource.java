 ...
 *
 */
public class MHRProcessReportSource extends org.spin.pr.model.MHRProcessReportSource {
	...
	public MHRProcessReportSource(Properties ctx, int HR_ProcessReportSource_ID, String trxName) {
		super(ctx, HR_ProcessReportSource_ID, trxName);
	}

	public MHRProcessReportSource(Properties ctx, ResultSet rs, String trxName) {
